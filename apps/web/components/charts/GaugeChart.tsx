...
export function GaugeChart({ value, label }: GaugeChartProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      <svg viewBox="0 0 200 120" className="h-40 w-full max-w-[280px]">
        <path d="M 30 100 A 70 70 0 0 1 170 100" fill="none" stroke="var(--track-muted)" strokeWidth="16" strokeLinecap="round" />
        <path
        ...
        />
        <line x1="100" y1="100" x2={x} y2={y} stroke={color} strokeWidth="4" />
